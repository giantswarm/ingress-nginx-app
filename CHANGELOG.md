...
- Controller: Update image to [`v1.10.2`](https://github.com/kubernetes/ingress-nginx/blob/main/changelog/controller-1.10.2.md). ([#668](https://github.com/giantswarm/ingress-nginx-app/pull/668))
