...
- Chart: Sync to upstream.
  - Controller: Update image to [v1.14.5](https://github.com/kubernetes/ingress-nginx/blob/main/changelog/controller-1.14.5.md).
...
[Unreleased]: https://github.com/giantswarm/ingress-nginx-app/compare/v4.2.5...HEAD
[4.2.5]: https://github.com/giantswarm/ingress-nginx-app/compare/v4.2.4...v4.2.5
