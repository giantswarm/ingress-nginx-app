...
- Update controller container image to [`v1.0.2`](https://github.com/kubernetes/ingress-nginx/blob/main/Changelog.md#102) which resolves issues related to lua modules used in the controller. ([#225](https://github.com/giantswarm/nginx-ingress-controller-app/pull/225))
