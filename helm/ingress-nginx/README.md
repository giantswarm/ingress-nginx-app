...
![Version: 3.0.0-beta1](https://img.shields.io/badge/Version-3.0.0--beta1-informational?style=flat-square) ![AppVersion: 1.8.1](https://img.shields.io/badge/AppVersion-1.8.1-informational?style=flat-square)
...
| controller.labels | object | `{"giantswarm.io/monitoring_basic_sli":"true"}` | Labels to be added to the controller Deployment or DaemonSet and other resources that do not have option to specify labels # |
| controller.labels."giantswarm.io/monitoring_basic_sli" | string | `"true"` | Enable Deployment or DaemonSet for SLI monitoring or not. Enabled by default. |
