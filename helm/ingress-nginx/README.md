...
![Version: 4.3.1](https://img.shields.io/badge/Version-4.3.1-informational?style=flat-square) ![AppVersion: 1.15.5](https://img.shields.io/badge/AppVersion-1.15.5-informational?style=flat-square)
...
| controller.image.digest | string | `"sha256:08c0b73d2fc472b82bf35c58534af1c34eb1e88d00abc6732274cd8730340d72"` |  |
| controller.image.digestChroot | string | `"not-available"` |  |
...
| controller.image.tag | string | `"v1.15.5"` |  |
