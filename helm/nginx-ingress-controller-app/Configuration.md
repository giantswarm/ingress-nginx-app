...
`cluster.profile` | Cluster usage profile. Dynamically calculated during cluster creation. Empty string ("") for unkown, "XS" for extra small. HPA is disabled and resource requests unset for "XS" clusters. | ""
